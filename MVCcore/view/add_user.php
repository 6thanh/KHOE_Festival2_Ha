...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form-control w-25 bg-dark m-auto">
            <div class="form-range mt-3">
                <input class="w-100 rounded ps-2" type="text" name="name" pattern="[a-zA-Z-' ]{3,}" 
                    title="3 or more characters" required placeholder="Name">
            </div> <br>
            ...
            <div class="form-range mt-2">
                <input type="tel" class="w-100 rounded ps-2" name="tel" minlength="10" maxlength="11" 
                    ...
                    title="Phone number starting with 0 or 84 followed by 9 digits, where the first digit cannot be 0" required placeholder="Phone number">
            </div> <br>

            <div class="form-range mt-2">
                <input id="password" type="password" class="w-75 rounded ps-2" name="password" 
                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
                    title="Password has 8 characters or more; have at least 1 uppercase character, 1 special character and 1 number" required placeholder="Password">
            ...
            <div class="form-range mt-2">
                <input type="password" class="w-75 rounded ps-2" name="rePassword" 
                    title="Confirm Password" required placeholder="Confirm Password" id="rePassword">
